...
---|---|---|---|---
[jsoncons](https://github.com/danielaparker/jsoncons)|8.424|3.592|423|Uses sorted `std::vector` of key/value pairs for objects, expect smaller memory footprint.Uses slightly modified [grisu3_59_56 implementation by Florian Loitsch](https://florian.loitsch.com/publications) plus fallback for printing doubles, expect faster serializing.
[nlohmann](https://github.com/nlohmann/json)|15.991|7.43|494|Uses `std::map` for objects. Uses slightly modified [Grisu2 implementation by Florian Loitsch](https://florian.loitsch.com/publications) for printing doubles, expect faster serializing.
[rapidjson](https://github.com/miloyip/rapidjson)|3.397|3.029|457|Uses custom floating point parsing, expect faster parsing. Uses girsu3 for printing doubles, expect faster serializing. Uses custom allocation and flat map for objects, expect smaller memory footprint.
[jsoncpp](https://github.com/open-source-parsers/jsoncpp)|56.405|30.169|2466|Uses std::map for both arrays and objects, expect larger memory footprint.
[glaze](https://github.com/stephenberry/glaze)|4.944|1.789|1086|
[Boost.JSON](https://www.boost.org/doc/libs/latest/libs/json/doc/html/index.html)|3.429|3.03|622|
[yyjson](https://github.com/ibireme/yyjson)|1.646|1.287|1205|
[reflect-cpp](https://github.com/getml/reflect-cpp)|23.033|4.547|1030|Uses yyjson for serializing and deserializing JSON.
